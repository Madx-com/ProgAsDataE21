...
namespace _1_4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Expr e1 = new Mul(new Add(new CstI(2), new Var("Something")), new CstI(42));
            Console.WriteLine(e1.ToString());

            Expr e2 = new Sub(new Mul(new CstI(2), new CstI(666)), new CstI(42));
            Console.WriteLine(e2.ToString());

            Expr e3 = new Mul(new Add(new CstI(2), new Var("Clint")), new Mul(new Var("S"), new Var("23654284523")));
